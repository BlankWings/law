...
if __name__ == '__main__':
    # 文件路径以及参数
    BASE_DIR = ".."
    DATA_FILE = "process3_data.txt"
    TRAIN_DIR = os.path.join(BASE_DIR, "data/train_data")
    TEST_DIR = os.path.join(BASE_DIR, "data/test_data")
    TRAIN_BUNCH_DIR = os.path.join(BASE_DIR, "data/train_bunch")
    TEST_BUNCH_DIR = os.path.join(BASE_DIR, "data/test_bunch")
    ...
    TFIDF_FILE = os.path.join(BASE_DIR, "model", "tfidf.m")
    #MODEL_FILE = os.path.join(MODEL_PATH, "nbmodel.m")
    MODEL_FILE = os.path.join(MODEL_PATH, "svmmodel.m")
    #MODEL_FILE = os.path.join(MODEL_PATH, "treemodel.m")
    #MODEL_FILE = os.path.join(MODEL_PATH, "svmmodel.m")
